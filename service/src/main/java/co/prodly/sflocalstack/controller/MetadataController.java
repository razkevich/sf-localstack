...
public class MetadataController {
    ...
    public MetadataController(MetadataSoapParser parser, MetadataSoapRenderer renderer, MetadataService metadataService) {
        this.parser = parser;
    ...
    public ResponseEntity<String> handle(@RequestBody String body) {
        try {
            ...
            String response = switch (request.operation()) {
                ...
                case "listMetadata" -> renderer.renderListMetadata(metadataService.listMetadata(firstQueryType(request.values()), firstQueryFolder(request.values())));
                case "readMetadata" -> {
