    ...
    <div className="grid h-full grid-cols-[1.1fr,0.9fr] overflow-hidden">
      <div className="overflow-auto border-r border-slate-800 bg-slate-950">
        <div className="border-b border-slate-800 px-6 py-5">
          <div className="text-xs uppercase tracking-[0.2em] text-cyan-300">Feature 1</div>
          <h2 className="mt-2 text-2xl font-semibold text-white">REST Core + SOQL</h2>
          <p className="mt-1 text-sm text-slate-400">
            Run supported SOQL against the emulator and inspect the shape of records the dashboard will expose.
          </p>
        </div>
