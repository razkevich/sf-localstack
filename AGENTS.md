...
- 001-sf-ci-emulator: Added Java 21 for backend, TypeScript 5.x with React 18 for dashboard + Spring Boot 3.3.5 (`web`, `data-jpa`, `actuator`, `test`), H2, Jackson JSON/YAML, React 18, Vite 5, Tailwind 3
